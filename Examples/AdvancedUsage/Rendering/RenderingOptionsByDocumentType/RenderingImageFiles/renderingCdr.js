...
async function renderingCdr(groupdocs, inputFilePath) {
  let outputFolder = `${groupdocs.outputFolder}/renderingCdr/html`;
  ...
  // TO JPG
  outputFolder = `${groupdocs.outputFolder}/renderingCdr/jpg`;
  ...
  // TO PNG
  outputFolder = `${groupdocs.outputFolder}/renderingCdr/png`;
  ...
  // TO PDF
  outputPath = `${groupdocs.outputFolder}/renderingCdr.pdf`;
