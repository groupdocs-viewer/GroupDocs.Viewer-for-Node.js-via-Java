...
async function renderingPlt(groupdocs, inputFilePath) {
  let outputPath = `${groupdocs.outputFolder}/renderingPlt.html`;
  ...
  // TO JPG
  outputPath = `${groupdocs.outputFolder}/renderingPlt.jpg`;
  ...
  // TO PNG
  outputPath = `${groupdocs.outputFolder}/renderingPlt.png`;
  ...
  // TO PDF
  outputPath = `${groupdocs.outputFolder}/renderingPlt.pdf`;
