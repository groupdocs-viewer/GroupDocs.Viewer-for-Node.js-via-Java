...
async function renderingCf2(groupdocs, inputFilePath) {
  let outputPath = `${groupdocs.outputFolder}/renderingCf2.html`;
  ...
  // TO JPG
  outputPath = `${groupdocs.outputFolder}/renderingCf2.jpg`;
  ...
  // TO PNG
  outputPath = `${groupdocs.outputFolder}/renderingCf2.png`;
  ...
  // TO PDF
  outputPath = `${groupdocs.outputFolder}/renderingCf2.pdf`;
